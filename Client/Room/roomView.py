...
class RoomView(ctk.CTkFrame):
    def __init__(self, parent):
        ...
        self.room_treeview.heading("#1", text="Index", anchor="center", command = lambda i: self.sort_by("player_id"))
    ...
    def owner_view(self, is_owner):
        if is_owner:
            ...
            self.state_button = ctk.CTkButton(self.room_frame, text='Change state', command=self.change_state ,height=40, width=300)
